...
public interface RetrofitService {
    ...
    // 2. 경로의 이름을 위 1번처럼 고정하지 않고 함수의 파라미터로 전달받아 지정할 수 있음
